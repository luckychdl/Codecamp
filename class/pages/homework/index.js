...
export default function Road() {
  ...
  return(
    ...
    <MainWrapper>
      <Header></Header>
      <Glass src='/ItsRoad/Glass.png' />
      <Wrapper>
        <SubWrapper>
          <My>마이</My>
          <Wrap>
            <ProfileImg src='/ItsRoad/Profile.png'/>
            <Lim>임정아</Lim>
            <Arrow src='/ItsRoad/Arrow3.png'/>
          </Wrap>
        </SubWrapper>
        <MenuWrapper>
          <Menu>공지사항</Menu>
      ...
      <BottomWrapper>
        <BottomSubWrapper>
          <BottomMenu src='/ItsRoad/Home.png'/>
          <div>홈</div> 
        </BottomSubWrapper>
        <BottomSubWrapper>
          <BottomMenu src='/ItsRoad/Location.png'/> 
          <div>잇츠로드</div>
        </BottomSubWrapper>
        <BottomSubWrapper>
          <BottomMenu src='/ItsRoad/Like.png'/> 
          <div>마이찜</div>
        </BottomSubWrapper>
        <BottomSubWrapper>
          <BottomMenu src='/ItsRoad/Selected.png'/> 
          <Text>마이</Text>
        </BottomSubWrapper>
