...
const classmates2 = [{ age: 10 }, { age: 15 }, { age: 13 }];
...
Object.keys(inputs)(4)[("name", "password", "title", "contents")];

Object.values(inputs)(4)[("철수", "1234", "title", "contents")];
...
// =========================================================================
const profiles2 = {
  1: { name: "철수", age: 13, school: "다람쥐초등학교" },
  2: { name: "영희", age: 16, school: "토끼초등학교" },
  3: { name: "훈이", age: 12, school: "강아지초등학교" },
};
// =========================================================================
// 결과:
Object.keys(profiles2).map((data) => ({ id: data, ...profiles2[data] }));
// =========================================================================
